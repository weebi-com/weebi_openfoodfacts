...
/// Enhanced product model with multi-language support
class WeebiProduct {
  /// Product barcode
  ...
  /// Create from OpenFoodFacts product
  factory WeebiProduct.fromOpenFoodFacts(off.Product product, WeebiLanguage language) {
    return WeebiProduct(
